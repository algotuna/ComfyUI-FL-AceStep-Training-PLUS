...
try:
    ...
    from .nodes.vae_loader import FL_AceStep_VAELoader
    ...
    NODE_CLASS_MAPPINGS = {
        ...
        "FL_AceStep_VAELoader": FL_AceStep_VAELoader,
    ...
    NODE_DISPLAY_NAME_MAPPINGS = {
        ...
        "FL_AceStep_VAELoader": "FL AceStep VAE Loader",
        ...
        "FL_AceStep_TrainingConfig": "FL AceStep Training Configuration (PLUS)",
        "FL_AceStep_Train": "FL AceStep Train LoRA (PLUS)",
    }
...
"""
    ...
    print("FL AceStep Training PLUS (memory-controls fork) Loaded - see FORK_NOTES.md")
